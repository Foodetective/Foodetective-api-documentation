...
export const items = [
  ...
  {
    title: "Addresses",
    links: [{ href: "/apis/addresses", children: "Addresses" }],
  },
  {
    title: "Banners",
    links: [{ href: "/apis/banners", children: "Banners" }],
  },
  {
    title: "Blog posts",
    links: [{ href: "/apis/blog-posts", children: "Blog posts" }],
  },
  {
    title: "Bookings",
    links: [{ href: "/apis/bookings", children: "Bookings" }],
  },
  {
    title: "Businesses",
    links: [
      ...
      {
        href: "/apis/businesses/direct-service-click",
        children: "Direct Service Click",
      },
      {
        href: "/apis/businesses/disconnect-stripe",
        children: "Disconnect Stripe",
      },
      { href: "/apis/businesses/dishes", children: "Dishes" },
      {
        href: "/apis/businesses/external-service-links",
        children: "External Service Links",
      },
      {
        href: "/apis/businesses/favourite-suppliers",
        children: "Favourite Suppliers",
      },
  ...
  {
    title: "Cards",
    links: [{ href: "/apis/cards", children: "Cards" }],
  },
  {
    title: "Categories",
    links: [{ href: "/apis/categories", children: "Categories" }],
  },
  {
    title: "Caterings",
    links: [
  ...
  {
    title: "Cities",
    links: [{ href: "/apis/cities", children: "Cities" }],
  },
  {
  ...
  {
    title: "Deliveries",
    links: [{ href: "/apis/deliveries", children: "Deliveries" }],
  },
  {
    title: "Devices",
    links: [{ href: "/apis/devices", children: "Devices" }],
  },
  {
    title: "Dishes",
    links: [{ href: "/apis/dishes", children: "Dishes" }],
  },
  {
    title: "Elements",
    links: [{ href: "/apis/elements", children: "Elements" }],
  },
  {
    title: "External Service Links",
    links: [
      {
        href: "/apis/external-service-links",
        children: "External Service Links",
      },
    ],
  },
  {
    ...
    links: [{ href: "/apis/external-services", children: "External Services" }],
  },
  {
  ...
  {
    title: "Favorites",
    links: [{ href: "/apis/favorites", children: "Favorites" }],
  },
  {
    title: "Feedbacks",
    links: [{ href: "/apis/feedbacks", children: "Feedbacks" }],
  },
  {
    title: "Groups",
    links: [{ href: "/apis/groups", children: "Groups" }],
  },
  {
    title: "Guides",
    links: [{ href: "/apis/guides", children: "Guides" }],
  },
  {
    title: "Intelligence Notifications",
    links: [
      {
        href: "/apis/intelligence-notifications",
        children: "Intelligence Notifications",
      },
    ],
  },
  {
    title: "Members",
    links: [{ href: "/apis/members", children: "Members" }],
  },
  {
    title: "Menus",
    links: [{ href: "/apis/menus", children: "Menus" }],
  },
  {
    title: "News Posts",
    links: [{ href: "/apis/news-posts", children: "News Posts" }],
  },
  {
    title: "Notifications",
    links: [{ href: "/apis/notifications", children: "Notifications" }],
  },
  {
    title: "Open Periods",
    links: [{ href: "/apis/open-periods", children: "Open Periods" }],
  },
  {
    title: "Order Periods",
    links: [{ href: "/apis/order-periods", children: "Order Periods" }],
  },
  {
    title: "Orders",
    links: [{ href: "/apis/orders", children: "Orders" }],
  },
  {
  ...
  {
    title: "Partners",
    links: [{ href: "/apis/partners", children: "Partners" }],
  },
  {
    title: "Payments",
    links: [{ href: "/apis/payments", children: "Payments" }],
  },
  {
    title: "Pictures",
    links: [{ href: "/apis/pictures", children: "Pictures" }],
  },
  {
  ...
  },
  {
    ...
    links: [{ href: "/apis/privatisations", children: "Privatisations" }],
  },
  {
    title: "Products",
    links: [{ href: "/apis/products", children: "Products" }],
  },
  {
    title: "Referrals",
    links: [{ href: "/apis/referrals", children: "Referrals" }],
  },
  {
    title: "Reservations",
    links: [{ href: "/apis/reservations", children: "Reservations" }],
  },
  {
    title: "Reviews",
    links: [{ href: "/apis/reviews", children: "Reviews" }],
  },
  {
    title: "Specializations",
    links: [{ href: "/apis/specializations", children: "Specializations" }],
  },
  {
    title: "Static Pages",
    links: [{ href: "/apis/static-pages", children: "Static Pages" }],
  },
  {
    title: "Stripe Plans",
    links: [{ href: "/apis/stripe-plans", children: "Stripe Plans" }],
  },
  {
    title: "Stripe Products",
    links: [{ href: "/apis/stripe-products", children: "Stripe Products" }],
  },
  {
    title: "Subscriptions",
    links: [{ href: "/apis/subscriptions", children: "Subscriptions" }],
  },
  {
    title: "Supplier",
    links: [
      ...
      {
        href: "/apis/supplier/product-categories",
  ...
  {
    title: "Tables",
    links: [{ href: "/apis/tables", children: "Tables" }],
  },
  {
    title: "Team Members",
    links: [{ href: "/apis/team-members", children: "Team Members" }],
  },
  {
    title: "Users",
    links: [
  ...
  {
    title: "Widgets",
    links: [{ href: "/apis/widgets", children: "Widgets" }],
  },
];
...
export const NavItem: React.FC<navItemProps> = ({ item, onClick }) => {
  ...
  return (
    <div key={item.title} className={`transition-all delay-75 duration-200`}>
      <div
        className="flex cursor-pointer items-center justify-between font-semibold uppercase"
        onClick={() => hide()}
      >
        <p className="m-0 font-bold dark:text-slate-400">{item.title}</p>
        {show ? (
          <FontAwesomeIcon
          ...
          return (
            ...
            >
              <Link {...link} legacyBehavior>
                <a className="wra text-sm font-medium text-slate-700 no-underline dark:text-slate-400">
                  {link.children}
                </a>
              </Link>
            </li>
...
export function SideNav({ className }) {
  return (
    <nav
      className={`${
        styles["sidenav"]
      } sticky hidden w-[280px] overflow-y-auto p-20 ${
        className ? className : ""
      }`}
    >
